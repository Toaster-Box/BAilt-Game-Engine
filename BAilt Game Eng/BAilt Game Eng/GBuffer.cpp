...
{ 
    ...
    if (m_GBufferData.bufferId > 0)
    {
        ...
        // Create Normal tex 32bit RGBA need 32 bc 8 ius unsigned
        m_GBufferData.Normal.id = rlLoadTexture(NULL, m_GBufferData.screenWidth, m_GBufferData.screenHeight, PIXELFORMAT_UNCOMPRESSED_R32G32B32A32, 1);
        m_GBufferData.Normal.width = m_GBufferData.screenWidth;
        m_GBufferData.Normal.height = m_GBufferData.screenHeight;
        m_GBufferData.Normal.format = PIXELFORMAT_UNCOMPRESSED_R32G32B32A32;
